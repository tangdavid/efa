...
def main():
    ...
    for fold in range(10):
        ...
        ide.fitModel(train, restarts=20, self_interactions=False, anchors=False)
        ce2.fitModel(train, restarts=20, self_interactions=True, anchors=False)
        ce3.fitModel(train, restarts=20, self_interactions=True, anchors=False)
        ce4.fitModel(train, restarts=20, self_interactions=True, anchors=False)
        adf.fitModel(train)
